...
try {
  ...
  $insertloss="INSERT INTO `DB_Pyrobel`.`listechutte` (`largeur`, `hauteur`, `dateMiseStock`,`commentaire`, `positionEmp`, `plateau_idPlateau`, `emplacement_idEmplacement`, `type_idType`, `deleted`)

  VALUES ('".$largeur."','".$hauteur."','".$day."','".$comment."','$nb','".$plateau."','".$emp."','".$type."','0')";
  //echo $insertloss;
